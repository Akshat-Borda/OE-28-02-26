...
const About = () => {
    return (
        <div>
            ...
            {/* Hero Section */}
            <section className="hero hero--short hero--image" style={{ backgroundImage: 'url("/images/stock/solar-park-1288842.webp")' }}>
            ...
            <section className="content-section fade-in" style={{ padding: 'var(--space-8) 0', backgroundColor: 'var(--color-bg-secondary)' }}>
                <div className="container">
                    <div style={{ maxWidth: '800px', margin: '0 auto', textAlign: 'left', borderLeft: '4px solid var(--color-primary)', paddingLeft: 'var(--space-6)' }}>
                        <h2 style={{ fontSize: 'var(--font-size-xl)', marginBottom: 'var(--space-3)' }}>What is OnLoop Energy?</h2>
                        <p style={{ fontSize: 'var(--font-size-base)', lineHeight: '1.6', margin: '0', color: 'var(--color-text-secondary)' }}>
                            <strong>OnLoop Energy</strong> is a commercial renewable energy Engineering, Procurement, and Construction (EPC) provider. We specialize in designing and delivering site-specific <strong>commercial hybrid energy systems</strong>, integrating industrial solar and small wind technologies. Unlike traditional solar installers, OnLoop Energy operates as an engineering-led partner, evaluating actual site constraints, load behaviors, and wind profiles to engineer hybrid architectures that guarantee long-term energy resilience and a lower cost of energy for C&I (Commercial & Industrial) and government facilities.
                        </p>
                    </div>
                </div>
            </section>
