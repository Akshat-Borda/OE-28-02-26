        ...
        <div>
                ...
                <div className="container">
                    <div className="grid-2">
                        ...
                        <div className="image-card image-card--large">
                            <img src="/images/stock/solar-panel-5542443_1920.webp" loading="lazy" alt="Commercial solar Operations and Maintenance (O&M) services by OnLoop Energy" />
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div className="container">
                    ...
                    <div className="grid-3">
                        <div className="card">
                            ...
                            <h4 className="card__title">RMS (Real-Time Monitoring System)</h4>
                            <p className="card__text">
                                Continuous tracking of generation, availability, and efficiency through our advanced RMS, benchmarked
            ...
            <section className="content-section fade-in">
                <div className="container">
                    <div className="grid-2">
                        <div>
                            <span className="content-section__label">RMS Integration</span>
                            <h2 className="content-section__title">From Raw Data to Actionable Insight</h2>
                            <p className="content-section__text">
                                Through our Real-Time Monitoring System (RMS), we ensure that data alone doesn’t just log performance—it actively improves it through intelligent interpretation.
                            </p>
